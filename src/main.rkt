...
(command-line #:program "fulmar"
              ...
              #:args non-flag-args (if (or (and (<= 1 (length non-flag-args))
                                       ...
                                       (let* ([source (cond [(cmdln-input-location)]
                                              ...
                                              [version (comment-env-chunk (concat "This file was generated by fulmar version "
                                                                                  version-number
                                                                                  "."))]
                                              ...
                                              [guard (cond [(eq? #true (cmdln-header))
                                                           ...
                                                           [else #false])]
                                              [header (if guard
                                                          (λ chunks (pp-header-file guard chunks))
                                                          (λ chunks chunks))]
                                              [context (construct-context (cmdln-line-length))]
                                              [path (cond [(cmdln-path)]
                                                          [else (current-directory)])])
                                         (print-code! (write-nekot (transform-chunks (list version
                                                                                           license
